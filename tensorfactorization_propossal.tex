...
\begin{figure}[!h]
 ...
 \begin{subfigure}[b]{0.29\textwidth}
  \includegraphics[width=\textwidth]{Images/3rd-order-tensor-fiber_mode-1.eps}\label{fig:3tensor-columns}
  \caption{columns}
 \end{subfigure}
 \begin{subfigure}[b]{0.33\textwidth}
  \includegraphics[width=\textwidth]{Images/3rd-order-tensor-fiber_mode-2.eps}\label{fig:3tensor-rows}
  \caption{rows}
 \end{subfigure}
 \begin{subfigure}[b]{0.33\textwidth}
  \includegraphics[width=\textwidth]{Images/3rd-order-tensor-fiber_mode-3.eps}\label{fig:3tensor-tubes}
  \caption{tubes}
 \end{subfigure}
...
The \textit{norm} of a tensor $\mathcal{X}\in \mathbb{R}^{I_1\times I_2 \ldots \times I_N}$

\subsection{Tensor decomposition}


Tensor decomposition originated with Hitchcock in 1927 (Reference of Kolda), and the the multi-way model is attribuited to Cattel in 1944 (Reference of Kolda).
...
% include figure about application fields.

% Extend applications descriptions and cite paper and survey Specific for each 
% field.
...
% 
% This WP will ensure effective planning, implementation, coordination and 
achievement of the project activities, including successful completion of the 
tasks and timely production of deliverables.
% 
% \subsubsection*{TASKS }
% \begin{itemize}
% \item T1.1: ADMINISTRATION AND MANAGEMENT. Will take care of financial and 
...
% \item T1.2: PROJECT FOLLOW UP AND QUALITY CONTROL. Will act as the final 
